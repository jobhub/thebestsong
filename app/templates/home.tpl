...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link  rel ="stylesheet" type="text/css" href="{$CONFIG_CSS}/style.css?v1"/>
        <link  rel ="stylesheet" type="text/css" href="{$CONFIG_CSS}/component.css"/>
        <script type="text/javascript" src="{$CONFIG_JS}/jquery/jquery-1.10.1.min.js"></script>              
        <script type="text/javascript" src="{$CONFIG_JS}/jquery/jquery.ddslick.min.js"></script>        
        <script type="text/javascript" src="{$CONFIG_JS}/jquery/jquery-ui-1.9.2.custom.min.js"></script>        
        <script type="text/javascript" src="{$CONFIG_JS}/jquery/jquery.hashchange.js"></script>
        <script src="{$CONFIG_JS}/modernizr.custom.js"></script>
    </head>
    <body id="home" class="cbp-spmenu-push" style="overflow-y: hiddena;">
        <div id="main" class="relative">
            <div id="header"><div class="logo"><img id="logo" src="{$CONFIG_CSS}/img/scroll_logo.png"></div></div>
            <div class="wrap fixed"></div>
            <div class="content absolute">
                {include file="home_page.html"}
                {include file="recent_page.html"}                                
                {include file="battle_page.html"}   
        ...
        <div class="nextPage">        
            <a href="#recent"><img src="{$CONFIG_CSS}/img/arrow.png"></a>
        </div>
        ...
        <script src="{$CONFIG_JS}/classie.js"></script>
